...
# Script to to build dataset folder for NER with train/test/dev split
#
# @author: Ajit Parikh
...
#
#
# @usage: python build_dataset_ner.py /path/to/ner_dataset /path/to/destination/ -p 70-15-15 --shuffle
